...
const VISIBLE_ATTRIBUTE_IMAGE = "visible-attribute-image";
const SELECTED_VISIBLE_ATTRIBUTE_IMAGE = "selected-visible-attribute-image";
...
const EXPAND_ICON = "expandIcon";
const FOLDER_ICON = "folderIcon";
const NOTE_ICON = "noteIcon";
const EMPTY_ICON = "emptyIcon";
const FOLDER = "folder";
const NOTE = "note";
